        ...
        <div className="features">
          <div className="left">
            <div className="items">
              ...
              <div className="item">
                <img src="/images/about-feature-2.jpeg" alt="" />
                <h2>Best service</h2>
                <span>
          ...
          <div className="right">
            <div className="items">
              <div className="item">
                <img src="/images/about-feature-3.jpg" alt="" />
                <h2>Food and beverages</h2>
                <span>
                  Delicious and healthy food is always to everyone's liking,
                  especially when food reduces fatigue and stress during travel.
